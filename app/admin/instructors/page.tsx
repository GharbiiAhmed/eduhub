  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Instructor Management</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            Manage platform instructors and their content
          </p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Instructors with highest ratings and most content
          </CardDescription>
        </CardHeader>
        <CardContent>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      {((instructor as any).coursesCount || 0) + ((instructor as any).booksCount || 0)} total content
                    </p>
                  </div>
                </div>
