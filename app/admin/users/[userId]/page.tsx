        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">
              {userProfile.full_name || userProfile.email?.split('@')[0] || 'User Details'}
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="text-lg font-semibold text-gray-900 dark:text-white mt-1">
                {userProfile.full_name || userProfile.email?.split('@')[0] || 'Not set'}
              </p>
            </div>
            <div>
            ...
            <div>
              <label className="text-sm font-medium text-gray-600 dark:text-gray-400">Last Active</label>
              <p className="text-lg font-semibold text-gray-900 dark:text-white mt-1">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                      ...
                      <div key={enrollment.id} className="p-4 border rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                        <div className="flex items-center justify-between">
                          ...
                          <Badge variant={enrollment.progress_percentage >= 100 ? 'default' : 'secondary'}>
                            {enrollment.progress_percentage >= 100 ? 'Completed' : 'In Progress'}
                          </Badge>
                        </div>
                      </div>
                    )
                  ...
                  {enrollmentsWithCourses.length > 5 && (
                    <p className="text-sm text-gray-600 dark:text-gray-400 text-center">
                      +{enrollmentsWithCourses.length - 5} more enrollments
                    </p>
                  )}
                </div>
              ) : (
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Books this student has purchased
              </CardDescription>
            </CardHeader>
            <CardContent>
              {bookPurchasesWithBooks && bookPurchasesWithBooks.length > 0 ? (
                <div className="space-y-4">
                  ...
                  {bookPurchasesWithBooks.length > 5 && (
                    <p className="text-sm text-gray-600 dark:text-gray-400 text-center">
                      +{bookPurchasesWithBooks.length - 5} more purchases
                    </p>
                  )}
                </div>
              ) : (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">No book purchases yet</p>
                </div>
              )}
            </CardContent>
          </Card>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              {instructorCourses && instructorCourses.length > 0 ? (
                <div className="space-y-4">
                  ...
                  {instructorCourses.length > 5 && (
                    <p className="text-sm text-gray-600 dark:text-gray-400 text-center">
                      +{instructorCourses.length - 5} more courses
                    </p>
                  )}
                </div>
              ) : (
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Books created by this instructor
              </CardDescription>
            </CardHeader>
            <CardContent>
              {instructorBooks && instructorBooks.length > 0 ? (
                <div className="space-y-4">
                  ...
                  {instructorBooks.length > 5 && (
                    <p className="text-sm text-gray-600 dark:text-gray-400 text-center">
                      +{instructorBooks.length - 5} more books
                    </p>
                  )}
                </div>
              ) : (
                <div className="text-center py-8">
                  <BookOpen className="w-12 h-12 text-gray-400 mx-auto mb-2" />
                  <p className="text-gray-600 dark:text-gray-400">No books created yet</p>
                </div>
              )}
            </CardContent>
          </Card>
