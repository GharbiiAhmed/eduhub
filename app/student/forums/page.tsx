      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            Connect with fellow students and discuss course topics
          </p>
        </div>
        <Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Share your thoughts or ask questions in the community
              </DialogDescription>
            </DialogHeader>
                ...
                <Select value={newPost.course_id} onValueChange={(value) => setNewPost(prev => ({ ...prev, course_id: value }))}>
                  ...
                  <SelectContent>
                    {coursesForDropdown.length === 0 ? (
                      <SelectItem value="" disabled>No enrolled courses</SelectItem>
                    ) : (
        ...
        <div className="lg:col-span-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Discussion forums for your enrolled courses
              </CardDescription>
            </CardHeader>
            <CardContent>
              {filteredForums.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
                    {enrolledCourses.length > 0 ? 'No Forums Yet' : 'No Forums Available'}
                  </h3>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    {enrolledCourses.length > 0 
                      ? 'Forums will be created automatically when you create your first post. Click "New Post" to get started!'
                      : 'You need to be enrolled in courses to see forums'}
                  </p>
                  {enrolledCourses.length === 0 && (
                    <Button asChild>
                      <Link href="/courses">
        ...
        <div>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Latest discussions across all forums
              </CardDescription>
            </CardHeader>
            <CardContent>
              {posts.length === 0 ? (
                  ...
                  {posts.map((post) => (
                    <div key={post.id} className="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-400 mb-2">
                        by {post.author_name} in {post.course_title}
                      </p>
