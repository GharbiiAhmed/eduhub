    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Share your thoughts with other students</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-4 pt-2 border-t">
                  ...
                  {post.replies_count > 0 && (
                    ...
                    >
                      ...
                      {expandedReplies.has(post.id) ? 'Hide' : 'Show'} Replies ({post.replies_count})
                    </Button>
                  )}
                </div>
                ...
                {expandedReplies.has(post.id) && post.forum_replies && post.forum_replies.length > 0 && (
                  <div className="space-y-3 border-t pt-4 mt-4">
                    <p className="text-sm font-semibold">Replies ({post.forum_replies.length})</p>
