          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  <Card className="border-0 shadow-lg bg-gradient-to-br from-blue-500 to-blue-600 text-white">
                    ...
                    <CardContent>
                      ...
                      <p className="text-xs text-white/80 mt-1">
                        {studentStats.coursesCompleted} completed
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-0 shadow-lg bg-gradient-to-br from-green-500 to-green-600 text-white">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                      <CardTitle className="text-sm font-medium text-white/90">Certificates</CardTitle>
                  ...
                  <Card className="border-0 shadow-lg bg-gradient-to-br from-purple-500 to-purple-600 text-white">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                      <CardTitle className="text-sm font-medium text-white/90">Hours</CardTitle>
                  ...
                  <Card className="border-0 shadow-lg bg-gradient-to-br from-yellow-500 to-yellow-600 text-white">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                      <CardTitle className="text-sm font-medium text-white/90">Ratings Given</CardTitle>
                ...
                {ratingsGiven.length > 0 && (
                  <Card className="border-0 shadow-xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
                    <CardHeader>
                      ...
                      <CardDescription>Courses you've rated</CardDescription>
                    </CardHeader>
                    <CardContent>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <Card className="border-0 shadow-lg bg-gradient-to-br from-blue-500 to-blue-600 text-white">
                    ...
                    <CardContent>
                      ...
                      <p className="text-xs text-white/80 mt-1">
                        {instructorStats.coursesPublished} published
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-0 shadow-lg bg-gradient-to-br from-green-500 to-green-600 text-white">
                    ...
                    <CardContent>
                      ...
                      <p className="text-xs text-white/80 mt-1">
                        {instructorStats.recentEnrollments} this week
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-0 shadow-lg bg-gradient-to-br from-yellow-500 to-yellow-600 text-white">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                      <CardTitle className="text-sm font-medium text-white/90">Rating</CardTitle>
                      <Star className="h-5 w-5 text-white/80" />
                    </CardHeader>
                    <CardContent>
                      ...
                      <p className="text-xs text-white/80 mt-1">
                        {instructorStats.totalRatings} ratings
                      </p>
                    </CardContent>
                  </Card>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <Card className="border-0 shadow-lg bg-gradient-to-br from-blue-500 to-blue-600 text-white">
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-white/80 mt-1">
                      {adminStats.totalStudents} students, {adminStats.totalInstructors} instructors
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-0 shadow-lg bg-gradient-to-br from-green-500 to-green-600 text-white">
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-white/80 mt-1">
                      {adminStats.totalEnrollments} enrollments
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-0 shadow-lg bg-gradient-to-br from-purple-500 to-purple-600 text-white">
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-sm font-medium text-white/90">Books</CardTitle>
                    <BookOpen className="h-5 w-5 text-white/80" />
                  </CardHeader>
                  <CardContent>
            ...
            <Card className="border-0 shadow-xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
              <CardHeader>
                ...
                <CardDescription>
                  {isEditing ? 'Edit your personal information' : 'Your personal details'}
                </CardDescription>
              </CardHeader>
              <CardContent>
                {error && (
