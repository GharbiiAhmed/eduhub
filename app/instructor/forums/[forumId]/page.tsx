...
export default function InstructorForumDetailPage({ params }: { params: Promise<{ forumId: string }> }) {
    ...
    return (
      <div className="text-center py-12">
        ...
        <Button asChild className="mt-4">
          <Link href="/instructor/forums">Back to Forums</Link>
        </Button>
      </div>
    )
  }
        ...
        {posts.length > 0 ? (
          ...
          <Card>
            <CardContent className="py-12 text-center">
              ...
              <p className="text-muted-foreground">No discussions yet. Students can start conversations here!</p>
            </CardContent>
          </Card>
        )}
      </div>
