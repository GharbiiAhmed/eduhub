  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Course Forums</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            Manage discussions and engage with students in your course forums
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Forums for courses you're teaching
          </CardDescription>
        </CardHeader>
        <CardContent>
          {filteredForums.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Forums will appear here when students create discussions in your courses
              </p>
            </div>
          ) : (
