          ...
          <div key={key} className="flex items-center justify-between p-4 border rounded-lg">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                ...
                {key === 'weekly_digest' && 'Get weekly summaries'}
                {key === 'achievement_alerts' && 'Celebrate achievements'}
                {key === 'reminder_emails' && 'Get reminders'}
            ...
            <div key={key} className="flex items-center justify-between p-4 border rounded-lg">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  ...
                  {key === 'allow_messages' && 'Allow students to message you'}
                  {key === 'show_progress' && 'Show your course statistics'}
                  {key === 'show_certificates' && 'Display your achievements'}
