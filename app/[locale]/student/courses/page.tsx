  ...
  return (
    <div className="space-y-8">
      ...
      {enrollments && enrollments.length > 0 ? (
                    ...
                    <div className="p-6 flex-1 flex flex-col">
                      ...
                      <div className="space-y-2 mb-4">
                        <div className="flex items-center justify-between text-xs">
                          <span className="text-muted-foreground">{tDashboard('progress')}</span>
        ...
        <div className="glass-effect rounded-3xl p-12 text-center border-primary/20 space-y-6">
          ...
          <div className="space-y-2">
            <h3 className="text-2xl font-bold">{tDashboard('noCoursesYet')}</h3>
            <p className="text-muted-foreground">{tDashboard('startLearningJourney')}</p>
          </div>
          <Link href="/courses">
      ...
      <AISuggestionsPanel
        ...
        userType="student"
        title={t('aiLearningRecommendations')}
      />
    </div>
  )
}
