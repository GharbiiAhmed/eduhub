  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold">{t('editQuiz')}</h1>
        <Button variant="outline" onClick={() => router.push("/instructor/quizzes")}>{t('back')}</Button>
      </div>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="grid gap-2">
              ...
              <Input id="limit" type="number" value={timeLimit} onChange={(e) => setTimeLimit(e.target.value)} placeholder={t('noLimit')} />
            </div>
            <div className="grid gap-2">
      ...
      <CardContent className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="md:col-span-2 grid gap-2">
            ...
            <Input id="newQuestion" placeholder={t('enterQuestionText')} value={newQuestionText} onChange={(e) => setNewQuestionText(e.target.value)} />
          </div>
          <div className="grid gap-2">
            <Label>Type</Label>
